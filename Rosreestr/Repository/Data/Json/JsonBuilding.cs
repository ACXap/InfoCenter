...
{
    public class JsonBuilding : JsonObject, IRealEstate
    {
        [JsonProperty("objectData", NullValueHandling = NullValueHandling.Ignore)]
        public JsonDataBuilding ObjectData { get; set; }

        public string KadastrNumber => ObjectData.NcadNum;

        public string Address => ObjectData.Address?.Note;
    ...
    public class Material
    {
        ...
        [JsonProperty("wallStr")]
        public string WallStr { get; set; }
    }
}